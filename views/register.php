 ...
 */
   ...
   if($_SESSION['regsuccess']){
      ...
      echo "<p>Thank you <b>".$_SESSION['reguname']."</b>, your information has been added to the database, "
          ."you may now <a href=\"ctrlpanel/usermain.php\">log in</a>.</p>";
   }
   /* Registration failed */
   else{
...
<h1>Register</h1>
<?
$_SESSION['url'] = "http://localhost".$_SERVER['PHP_SELF'];
...
<tr><td colspan="2" align="left"><a href="ctrlpanel/usermain.php">Back to Main</a></td></tr>
</table>
</form>
