...
if (!isset($_COOKIE['visited'])) {
	setcookie(visited, true, $hourLater, '/', '.mydevwares.com', false);
}
...
<div class="container_16" id="wrapper">
	...
	<div class="grid_16">
		<div id="blue_splash">
			...
			<img src="../models/UI/global_imgs/splashDeco.jpg" style="margin-top:2px;" />
			<!-- InstanceEndEditable -->
			<div id="searchform">
		...
		<div id="maincontent">
			<div class="content_bg">
				...
				<p> Web designers and developers unite! Welcome to myDevWares, a Canadian-based
					...
					provide a range of services to developers and internet entrepreneurs including
				...
				<ol start="1" type="1">
					...
					<li>You make 91% in<em> cold, hard, cash</em> on every sale! (myDevWares
						takes a tiny commision of 9% -
						<a href="advantages.php" title="Advantages of myDevWares">
						see advantages
						</a>
						)</li>
				</ol>
	...
	<div class="grid_5">
		<script type="text/javascript" charset="utf-8" language="javascript" src="http://static.polldaddy.com/p/1547205.js"></script><noscript> <a href ="http://answers.polldaddy.com/poll/1547205/" >What do you think of the overall concept of myDevWares?</a>  <br/> <span style="font-size:9px;"> (<a href ="http://www.polldaddy.com">  online polls</a>)</span></noscript>
		<h1>myDevWares is not yet live...</h1>
...
<div id="dialog" title="myDevWares is still under construction!">
	<h1>myDevWares is Under Construction!</h1>
	<p><strong>Can't wait to start using myDevWares?</strong></p>
